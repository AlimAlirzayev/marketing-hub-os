...
this is judgment encoded, not taste.

| # | Dimension | 5 looks like | 1 looks like | Source |
|---|---|---|---|---|
| 1 | **One-truth focus** (KILL) | The concept dramatizes exactly ONE truth; everything else was sacrificed | Two messages fused; "and also…" | Bernbach (kill the cleverness); Sullivan's sacrifice-and-focus |
| 2 | **Product/brand truth** (KILL) | Built on a real, verifiable fact or genuinely held belief; survives unmasking | Polished lie; values tourism; invented virtue | Bernbach ("a great campaign makes a bad product fail faster"); Droga (defensible when unmasked) |
| 3 | **Pattern break** | Violates the category's reigning convention on purpose; nobody in the category has done this | Category wallpaper; "proven" template refill | Bernbach (rules broken); Droga (mediocrity = default failure) |
...
- Score 1–5 per dimension, one line of justification each — cite the
